...
const execBoardList:Array<[string,string,string,any]> = [
    ["Arch Silverstein", "President/Founder", "Leads weekly meetings, makes weekly slides", myimg],
    ["Daniel Rivero", "Vice President", "Makes weekly slides, leads every 4th meeting",myimg],
    ["Andrew Watson", "Treasurer", "In charge of the finances, Deals with SOFO",myimg],
